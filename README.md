...
4. Crie uma nova **branch** e nomeie como `feat/community/renatom06`: `git checkout -b feat/community/seunomedeusuario`;
    > Exemplo: `git checkout -b feat/community/renatom06`
